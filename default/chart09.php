...
$total_custopp[] = $row['Jumlah_Customer'];
$total_custo[] = $row['Jumlah_Film'];
$total_custom[] = $row['lamapinjam'];
$total_custome[] = $row['time_id'];
      ...
      function drawChart() {
       ...
       var data = new google.visualization.DataTable();
 		data.addColumn('string', 'Topping');
          ...
          ['ALDO',     <?php echo ($row(['Jumlah_Customer'][0]))?>],
          ['KUNAM3',      <?php echo ($row[1])?>],
          ['Commute',  <?php echo ($row[4])?>],
          ['Watch TV', 2],
          ['Sleep',    7]
        ]);
  ...
  <body>
    <div id="curve_chart" style="width: 900px; height: 500px"></div>
	  ...
	  <?php 
						...
						echo ', '; 
						echo json_encode($total_custo); 
						echo ', '; 
						echo json_encode($total_custom);
						echo ', '; 
						echo json_encode($total_custome); 
...
jQuery(function($) {
  ...
  Echart.dashboardEcharts = function() {
    ...
    /*--------------- Chart 1 -------------*/
    if($("#platform_type_dates_donutt").length){
      var myChart = echarts.init(document.getElementById('platform_type_dates_donutt'));
            ...
            series : [
              {
                ...
                data:[{value: 35,  name:'iPhone 7'}, {value: 16,  name:'Windows'}, {value: 500,  name:'Desktop'}, {value: 29,  name:'Mobiles'}, {value: 12,  name:'Others'}]
              }
            ]
          },
          {
            series : [
              {
                name:'05-16',
                type:'pie',
                data:[{value: 42,  name:'iPhone 7'}, {value: 51,  name:'Windows'}, {value: '<?php echo 50+700; ?>',  name:'Desktop'}, {value: 25,  name:'Mobiles'}, {value: 9,  name:'Others'}]
              }
            ]
          },
          {
